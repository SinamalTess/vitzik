...
export function formatToPixelValue(input: any) : string { // type 'any' is on purpose Bere :p
...
export function noteKeyToName(key: number): string {
    // standard piano keys (88) in english
    const keys = [
        'A0',
        'A#0/Bb0',
        'B0',
    ...
    return keys[key - 21] // 21 is the offset calculated from : https://www.inspiredacoustics.com/en/MIDI_note_numbers_and_center_frequencies
